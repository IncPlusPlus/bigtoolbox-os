...
public abstract class OperatingSystem {
  ...
  public final OperatingSystem getSkeleton(
      OSFamily osFamily, String majorVersion, String minorVersion) throws UnsupportedOSException {
    return getSkeleton(osFamily, majorVersion, minorVersion, "");
  }

  public final OperatingSystem getSkeleton(
      OSFamily osFamily, String majorVersion, String minorVersion, String buildVersion)
   ...
   */
  // abstract OperatingSystem getSkeletonOS(String majorVersion, String minorVersion, String
  // buildVersion);
}
